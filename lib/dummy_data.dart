...
import 'package:fashionapp/models/category_model.dart';
import 'package:fashionapp/models/popular_model.dart';
...
List<PopularModel> popularList = [
  PopularModel(
    picture: 'assets/pictures/popular2.jpg',
    price: 35,
    title: 'Second shirt',
  ),
  PopularModel(
    picture: 'assets/pictures/popular3.jpg',
    price: 50,
    title: 'Some other',
  ),
  PopularModel(
    picture: 'assets/pictures/popular4.jpg',
    price: 92,
    title: 'Last shirt',
  ),
  PopularModel(
    picture: 'assets/pictures/popular1.jpg',
    price: 75,
    title: 'First shirt',
  ),
  PopularModel(
